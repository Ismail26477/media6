    ...
    <section id="work" className="relative py-20 md:py-32">
      ...
      <div className="container mb-16">
        ...
        >
          ...
          <h1 className="text-6xl sm:text-7xl lg:text-8xl font-black text-foreground tracking-tight leading-none mb-4">
            Our <span className="text-primary">Work</span>
          </h1>
          <p className="text-muted-foreground uppercase tracking-[0.3em] text-xs md:text-sm">
